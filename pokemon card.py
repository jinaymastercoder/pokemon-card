...
bulbasour =ImageTk.PhotoImage(Image.open ("balbasour.png"))
Charmender =ImageTk.PhotoImage(Image.open ("charminder.png"))
...
Iyvasour =ImageTk.PhotoImage(Image.open ("Iyvasour.png"))
